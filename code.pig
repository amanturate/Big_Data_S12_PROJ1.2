A = load '/user/govt_progress/StatewiseDistrictwisePhysicalProgress.xml' using org.apache.pig.piggybank.storage.XMLLoader('row') as (x:chararray);
...
STORE D INTO '/user/govt_progress/xml_to_csv' USING org.apache.pig.piggybank.storage.CSVExcelStorage();
